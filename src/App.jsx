...
const usersDb = {
  ...
  student3: { id: "705", email: 'damir1@gmail.com', pass: 'damir20261', name: ' дамир а.', role: 'Student', avatar: '👨‍🎓' },
  student3: { id: "505", email: 'aziz@gmail.com', pass: 'damir2026', name: 'aziz O.', role: 'Student', avatar: '👨‍🎓' },
        ...
        <div className="auth-card fade-in">
          ...
          <div className="login-hints">
            ...
            <div className="hint-chips">
              ...
              <button onClick={() => { setEmail('aziz@gmail.com'); setPassword('damir2026'); }}>aziz O</button>
              <button onClick={() => { setEmail('damir1@gmail.com'); setPassword('damir20261'); }}>дамир А</button>
